...
import { Canvas, Rect, Text, vec, Line, matchFont, Skia, TextAlign, listFontFamilies, RoundedRect, Group } from "@shopify/react-native-skia";
import { getFormattedString, isDefined } from "../util/util.js";
import { jsx as _jsx, jsxs as _jsxs } from "react/jsx-runtime";
const systemFontFamilies = Platform.select({
...
function arrayFrom(maxValue, interval) {
  return Array.from({
...
function ToolTip({
  ...
  // Adjust tooltip to stay above the point
  const tooltipX = x + 5;
